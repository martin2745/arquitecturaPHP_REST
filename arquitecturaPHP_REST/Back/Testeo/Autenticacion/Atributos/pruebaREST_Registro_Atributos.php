...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
												//ERRORES_ATRIBUTO rol
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&

	//registrar ROL_NAME_VACIO
	$POST['contrasena'] = '21232f297a57a5a7f3894a0e4a801fc3';
	$POST['rol'] = '';

	$prueba = 'El nombre del rol está vacio.';
	$codeEsperado = 'ROL_NAME_VACIO';
	$pruebas->hacerPrueba($POST, $POST['controlador'], $POST['action'], $atributo, $prueba, $codeEsperado);

//---------------------------------------------------------------------------------------------------------------------
	
	//registrar ROL_NAME_MENOR_QUE_3
	$POST['rol'] = 'A';

	$prueba = 'El nombre del rol es menor de 3.';
	$codeEsperado = 'ROL_NAME_MENOR_QUE_3';
	$pruebas->hacerPrueba($POST, $POST['controlador'], $POST['action'], $atributo, $prueba, $codeEsperado);

//---------------------------------------------------------------------------------------------------------------------
	
	//registrar ROL_NAME_MAYOR_QUE_45
	$POST['rol'] = 'aaaaaaaaaaaaaaaaaaaaaaaaaa
	aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
	aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa';

	$prueba = 'El nombre del rol es mayor de 45.';
	$codeEsperado = 'ROL_NAME_MAYOR_QUE_45';
	$pruebas->hacerPrueba($POST, $POST['controlador'], $POST['action'], $atributo, $prueba, $codeEsperado);

//---------------------------------------------------------------------------------------------------------------------
	
	//registrar ROL_NAME_FORMATO_INCORRECTO
	$POST['rol'] = 'A@#~€¬A';

	$prueba = 'El nombre del rol tiene un formato erroneo, solo letras y números.';
	$codeEsperado = 'ROL_NAME_FORMATO_INCORRECTO';
	$pruebas->hacerPrueba($POST, $POST['controlador'], $POST['action'], $atributo, $prueba, $codeEsperado);
