<?php
    ...
    class usuarioAtributos{
        ...
        function buscarPerfil(){
            include_once './Testeo/GestionUsuarios/Atributos/pruebaREST_Usuario_BuscarPerfil_Atributos.php';
            $rest = pruebaREST_Usuario_BuscarPerfil_Atributos();
            $respuesta['datos'] = $rest;
            if(calcularCodeExito($respuesta['datos'])){
                $respuesta['code'] = 'PETICION_TEST_USUARIO_BUSCARPERFIL_ATRIBUTOS_EXITO';
            }
            else{
                $respuesta['code'] = 'PETICION_TEST_USUARIO_BUSCARPERFIL_ATRIBUTOS_FRACASO';
            }
            devolverRespuestaTest($respuesta);
        }
