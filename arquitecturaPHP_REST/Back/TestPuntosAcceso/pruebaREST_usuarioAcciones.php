<?php
    ...
    class usuarioAcciones{
        ...
        function buscarPerfil(){
            include_once './Testeo/GestionUsuarios/Acciones/pruebaREST_Usuario_BuscarPerfil_Acciones.php';
            $rest = pruebaREST_Usuario_BuscarPerfil_Acciones();
            $respuesta['datos'] = $rest;
            if(calcularCodeExito($respuesta['datos'])){
                $respuesta['code'] = 'PETICION_TEST_USUARIO_BUSCARPERFIL_ACCIONES_EXITO';
            }
            else{
                $respuesta['code'] = 'PETICION_TEST_USUARIO_BUSCARPERFIL_ACCIONES_FRACASO';
            }
            devolverRespuestaTest($respuesta);
        }
