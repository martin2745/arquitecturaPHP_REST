...
class usuario_VALIDATION_ATRIBUTO extends Validar{
	...
	function validar_atributos_buscarPerfil(){
		$this->validar_usuario_buscar();	
	}
...
///////////////////////////////////////////////////////////////////////////////////////////
	...
	function validar_rol(){
		if($this->Es_Vacio($this->rol)===true){
			throw new excepcionAtributos('ROL_NAME_VACIO');
		}

		if($this->Longitud_minima($this->rol,3)===false){
			throw new excepcionAtributos('ROL_NAME_MENOR_QUE_3');
		}

		if($this->Longitud_maxima($this->rol,45)===false){
			throw new excepcionAtributos('ROL_NAME_MAYOR_QUE_45');
		}

		if($this->comprobarLetrasNumerosSinEspacios($this->rol)===false){
			throw new excepcionAtributos('ROL_NAME_FORMATO_INCORRECTO');
		}

		/**
		 * HAY QUE DEFINIR LOS TIPOS DE ROLES DE LA APLICACIÓN Y VALIDARLOS
		 */
	}
