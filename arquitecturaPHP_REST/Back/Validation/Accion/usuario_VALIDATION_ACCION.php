...
//////////////////////////////////////Funciones para disparar las excepcion/////////////////////////////////////////
	 ...
	 */
		...
		/**
		 * Se comprueba cual es el rol del usuario a insertar. No se puede insertar un usuario administrador.
		 */
		function rol_admin(){
			if($this->modelo->arrayDatoValor['rol'] == 'administrador'){ return false; }
			else{ return true; }
		}
